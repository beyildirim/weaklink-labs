...
!!! note "Simulated firmware"
    This lab uses simulated firmware files that represent the structure of real UEFI images. In production, you would use binwalk or uefi-firmware-parser for binary analysis.
