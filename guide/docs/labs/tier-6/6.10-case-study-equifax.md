...
Unlike Log4Shell, Struts was a **direct dependency** listed in the `pom.xml`. The version number was right there. The CVE was a perfect match. There was no excuse for not knowing.
