...
???+ tip "Checkpoint"
    ...
    1. What two SBOM formats did you generate, and how do their structures differ?
    2. Name three categories of components the SBOM missed and why.
    3. What is a purl and why does it matter for vulnerability matching?
...
??? tip "SOC Relevance"
    ...
    **Alert you will see:** "Vulnerability scanner found CVE in component not listed in SBOM"
    ...
    3. **SBOM was tampered with**. component deliberately removed (see [Lab 4.7](4.7-sbom-tampering.md))
