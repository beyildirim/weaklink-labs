...
???+ tip "Checkpoint"
    ...
    1. Why did all three SBOM tools miss the vendored libxml2?
    2. What is the false negative rate for your best SBOM tool?
    3. How would this gap affect a compliance audit that relies solely on SBOM data?
