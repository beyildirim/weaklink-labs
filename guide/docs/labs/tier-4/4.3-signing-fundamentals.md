...
???+ tip "Checkpoint"
    ...
    1. What three properties does a signature prove?
    2. Why did Kubernetes accept the unsigned image without complaint?
    3. What is the difference between signing with cosign vs. GPG?
