...
In [Lab 7.2](7.2-incident-triage.md), you triaged a dependency confusion incident as a one-off exercise. In a real organization, you need a playbook: a repeatable, tested procedure that any analyst can follow at 3 AM when the pager fires.
...
???+ success "Phase 3: VALIDATE. Walk Through the Lab 7.2 Scenario"
    ...
    **Goal:** Apply the playbook to the dependency confusion incident from [Lab 7.2](7.2-incident-triage.md).
