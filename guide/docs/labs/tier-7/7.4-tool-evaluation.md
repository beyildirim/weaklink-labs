...
2. **SIEM detection rules**. the rules from [Lab 7.1](7.1-detection-rules.md) catch what no scanner can.
3. **Incident response playbooks**. [Lab 7.3](7.3-ir-playbook.md) is your response when tools fail.
