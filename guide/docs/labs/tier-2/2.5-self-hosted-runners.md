...
**Sigma -- File Creation Outside Workspace on CI Runner:**
...
*   **Known False Positives**: setup-node, setup-python write to _work/_tool/. Exclude known setup action paths.
*   **Tuning Strategy**: Focus on .sh files, hidden directories, and files written during PR builds.
</details>

**Sigma -- Process Surviving CI Job Completion:**
...
**Tuning & False Positives**
*   **Known False Positives**: Some actions start background processes for caching.
*   **Tuning Strategy**: Focus on network-capable processes surviving job completion.
</details>

**Sigma -- Runner State Hash Mismatch:**
...
**Tuning & False Positives**
*   **Known False Positives**: Runner auto-updates and tool cache population change the hash.
