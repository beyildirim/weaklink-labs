...
**Sigma -- Shell Metacharacters in Issue or PR Title:**
...
*   **Known False Positives**: Issues about shell scripting may contain $ or &&. Check author_association: NONE with injection patterns is high-signal.
*   **Tuning Strategy**: Correlate with whether the repo has workflows using direct expression interpolation in run: blocks.
</details>

**Sigma -- Outbound Connection from Issue-Triggered Workflow:**
...
**Tuning & False Positives**
*   **Known False Positives**: Notification bots (Slack webhooks) make outbound calls. Allowlist known endpoints.
*   **Tuning Strategy**: Issue-triggered workflows should have a very short outbound allowlist.
</details>

**Sigma -- Shell Injection Patterns in PR Branch Names:**
...
**Tuning & False Positives**
*   **Known False Positives**: Nearly zero. Shell metacharacters have no legitimate use in branch names.
