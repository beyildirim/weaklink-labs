...
```bash
cat src/buildspec-vulnerable.yml    # Fetches /prod/ secrets
cat src/cloudbuild-vulnerable.yaml  # User-controlled substitution variables
cat src/iam-policy-vulnerable.json  # ssm:*, s3:*, iam:PassRole, sts:AssumeRole on *
```
