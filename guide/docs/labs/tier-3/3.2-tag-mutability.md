...
!!! checkpoint "Phase 2 Checkpoint"
    ...
    - What is the difference between the two digests you recorded?
    - Would `imagePullPolicy: IfNotPresent` have prevented this attack? Under what conditions?
    - How would you detect this happened from Kubernetes events alone?
