...
??? tip "SOC Relevance"
    ...
    **Alert you will see:** "Build server making outbound connections to pypi.org"
    ...
    Either way, this alert is high-signal. The remediation is always the same: switch to `--index-url` (single registry) and verify lockfiles exist. This is a quick win for any SOC. low false-positive rate and directly maps to preventing dependency confusion ([Lab 1.2](1.2-dependency-confusion.md)).
