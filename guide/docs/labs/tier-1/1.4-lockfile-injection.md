...
Open Gitea at `http://gitea:3000/developer/webapp/pulls/1`, or inspect from the command line:
...
### Defense 4: CI pipeline integration
...
If someone submits a lockfile that doesn't match a fresh `pip-compile` output, the CI fails.
