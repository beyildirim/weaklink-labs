...
4 commits on `main`. **Question:** What was the first thing added? Check the oldest commit message.
...
**Question:** What files changed? How many lines added vs removed?
...
Open `http://gitea:3000/labadmin/web-app/commits/branch/main` and click the latest commit. The malicious line is in the diff, buried among legitimate changes. In a PR with 500 changed lines, would you have caught it?
