...
5. In the Gitea web interface (http://localhost:3000), log in as `labadmin` / `SupplyChainLab1!`, go to the `ci-demo` repo, and click the **Actions** tab. Watch the pipeline run and succeed.
