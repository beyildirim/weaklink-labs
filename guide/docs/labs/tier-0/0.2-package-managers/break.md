...
On the real PyPI (pypi.org), there are over 500,000 packages. Any one of them could have a malicious `setup.py`. Typosquatting attacks ([Lab 1.3](../../tier-1/1.3-typosquatting/index.md)) create packages with names like `reqeusts` instead of `requests`, hoping people make typos.
