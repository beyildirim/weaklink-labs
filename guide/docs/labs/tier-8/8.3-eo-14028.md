...
| Question | Answer |
|----------|--------|
| Is there an incident response playbook? | (Lab 7.3) |
...
| Incident notification process | Playbook exists (Lab 7.3) but no federal-specific procedures | 40% |
| SSDF self-attestation | Draft from Lab 8.2 | 50% |
