...
def run(context: InitContext) -> InitResult:
    ...
    seed_git_repo_from_source(
        ...
        repo_name=repo_name,
        commit_message="Initial commit: WeakLink webapp with CI pipeline",
    )
    set_repo_secret(repo_name, "SECRET_TOKEN", "sk-wl-prod-7f3a9b2c4d5e6f1a")
    set_repo_secret(repo_name, "DEPLOY_TOKEN", "ghp_deploy_x8k2m5n7p9q1r3t6v0w4y")
    set_repo_secret(repo_name, "AWS_ACCESS_KEY_ID", "AKIAIOSFODNN7EXAMPLE")
